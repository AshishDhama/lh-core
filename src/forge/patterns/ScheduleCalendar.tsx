            ...
            <div className="flex flex-col gap-1.5">
              {dayEvents.map((ev) => {
                ...
                return (
                  <div
                    key={ev.id}
                    className="flex items-center gap-3 px-4 py-3 rounded-xl border border-[#e2e8f0] bg-white hover:border-[#A3C5E5] cursor-pointer transition-colors"
          ...
          {(['month', 'week', 'day'] as CalendarView[]).map((v) => (
            <button
              ...
              className={cn(
                ...
                view === v
                  ? 'bg-white text-[#002C77] shadow-sm'
